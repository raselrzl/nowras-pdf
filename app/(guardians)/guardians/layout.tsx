    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <aside className="w-64 bg-gray-900 text-white p-4 flex flex-col gap-2">
          <Link className="bg-gray-800 px-3 py-2 rounded-xs" href="/administration/guardians">
            All Guardians
          </Link>
          <Link className="bg-gray-800 px-3 py-2 rounded-xs" href="/administration/guardians/create">
            Add Guardian
          </Link>
        </aside>
